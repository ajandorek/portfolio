    ...
    return (
        <div>
            ...
            <div className="callout">
                ...
                <p>A simple hangman game with a Fallout Theme.</p>
                <h5>Technologies Used</h5>
                <ul>
                    <li>Javascript</li>
                </ul>
                <a className='hollow button primary' href="https://fallout-hangman.herokuapp.com/" target="_blank">Click Here</a>
            </div>
            <div className="callout">
                <h4 className='text-center'>Overwatch RPG</h4>
                <img src={'http://i.imgur.com/qbBRC4d.png'} />
                <p>A role playing game with an overwatch spin.</p>
                <h5>Technologies Used</h5>
                <ul>
                    <li>jQuery</li>
                    <li>jQuery UI</li>
                </ul>
                <a className='hollow button primary' href="https://overwatch-rpg.herokuapp.com/" target="_blank">Click Here</a>
            </div>
            <div className="callout">
